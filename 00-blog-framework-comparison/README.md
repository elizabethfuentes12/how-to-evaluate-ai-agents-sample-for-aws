...
> **✅ Updated:** This notebook uses **explicit `OpenAIModel`** for Strands Agents to ensure all three frameworks use OpenAI (gpt-4o-mini) for fair comparison. Works in any environment. See [NOTEBOOK_FIX_SUMMARY.md](./NOTEBOOK_FIX_SUMMARY.md) for technical details.
